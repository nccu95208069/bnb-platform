...
- Final release: `sweetfun-6ik7ttmch-sweetfuns-projects.vercel.app` aliased to Sweetfun OS. Full frontend suite now 120/120 passed. Known unclaimed Agoda order readback returned legacy_unclaimed, customer unknown, receipt unknown, registry_version=1 and sheet_write=false (HTTP 200). No critical issue remains in this reviewed increment.
