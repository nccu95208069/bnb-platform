...
/** Treat only explicit "confirmed" as usable for rates/heat; draft/pending/missing → unconfirmed. */
 ...
 * for every catalog room. Pending/draft never uses inventory for totals even if present by mistake.
