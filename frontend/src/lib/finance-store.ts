...
export function applyFinance(state:FinanceState,input:Record<string,unknown>,actor:Principal,property:string,year:number,now=new Date().toISOString(),members:Member[]=[],accounts:PaymentAccount[]=[]) {
